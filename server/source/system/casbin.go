...
func (i *initCasbin) InitializeData(ctx context.Context) (context.Context, error) {
	...
	entities := []adapter.CasbinRule{
		...
		// ops 运维中心(资产管理 / 跳板机 / 工单发版)
		{Ptype: "p", V0: "888", V1: "/ops/createAsset", V2: "POST"},
		{Ptype: "p", V0: "888", V1: "/ops/updateAsset", V2: "PUT"},
		{Ptype: "p", V0: "888", V1: "/ops/deleteAsset", V2: "DELETE"},
		{Ptype: "p", V0: "888", V1: "/ops/getAssetList", V2: "POST"},
		{Ptype: "p", V0: "888", V1: "/ops/createCredential", V2: "POST"},
		{Ptype: "p", V0: "888", V1: "/ops/updateCredential", V2: "PUT"},
		{Ptype: "p", V0: "888", V1: "/ops/deleteCredential", V2: "DELETE"},
		{Ptype: "p", V0: "888", V1: "/ops/getCredentialList", V2: "POST"},
		{Ptype: "p", V0: "888", V1: "/ops/testConnection", V2: "POST"},
		{Ptype: "p", V0: "888", V1: "/ops/execCommand", V2: "POST"},
		{Ptype: "p", V0: "888", V1: "/ops/terminal", V2: "GET"},
		{Ptype: "p", V0: "888", V1: "/ops/createTicket", V2: "POST"},
		{Ptype: "p", V0: "888", V1: "/ops/deleteTicket", V2: "DELETE"},
		{Ptype: "p", V0: "888", V1: "/ops/approveTicket", V2: "POST"},
		{Ptype: "p", V0: "888", V1: "/ops/cancelTicket", V2: "POST"},
		{Ptype: "p", V0: "888", V1: "/ops/getTicketList", V2: "POST"},
		{Ptype: "p", V0: "888", V1: "/ops/findTicket", V2: "GET"},
		// ops 运维大盘 / 审计 / 巡检 / 文件管理
		{Ptype: "p", V0: "888", V1: "/ops/getDashboard", V2: "GET"},
		{Ptype: "p", V0: "888", V1: "/ops/getAuditList", V2: "POST"},
		{Ptype: "p", V0: "888", V1: "/ops/createInspectTask", V2: "POST"},
		{Ptype: "p", V0: "888", V1: "/ops/updateInspectTask", V2: "PUT"},
		{Ptype: "p", V0: "888", V1: "/ops/toggleInspectTask", V2: "POST"},
		{Ptype: "p", V0: "888", V1: "/ops/runInspectTask", V2: "POST"},
		{Ptype: "p", V0: "888", V1: "/ops/deleteInspectTask", V2: "DELETE"},
		{Ptype: "p", V0: "888", V1: "/ops/getInspectTaskList", V2: "POST"},
		{Ptype: "p", V0: "888", V1: "/ops/getInspectResultList", V2: "POST"},
		{Ptype: "p", V0: "888", V1: "/ops/listDir", V2: "POST"},
		{Ptype: "p", V0: "888", V1: "/ops/readFile", V2: "POST"},
		{Ptype: "p", V0: "888", V1: "/ops/writeFile", V2: "POST"},
		{Ptype: "p", V0: "888", V1: "/ops/removeFile", V2: "POST"},
		{Ptype: "p", V0: "888", V1: "/ops/renameFile", V2: "POST"},
		{Ptype: "p", V0: "888", V1: "/ops/mkdir", V2: "POST"},
		// ops 资产分组 / 告警 / 调度中心 / 备份
		{Ptype: "p", V0: "888", V1: "/ops/createAssetGroup", V2: "POST"},
		{Ptype: "p", V0: "888", V1: "/ops/updateAssetGroup", V2: "PUT"},
		{Ptype: "p", V0: "888", V1: "/ops/deleteAssetGroup", V2: "DELETE"},
		{Ptype: "p", V0: "888", V1: "/ops/getAssetGroupList", V2: "POST"},
		{Ptype: "p", V0: "888", V1: "/ops/getAllAssetGroups", V2: "GET"},
		{Ptype: "p", V0: "888", V1: "/ops/getAlertList", V2: "POST"},
		{Ptype: "p", V0: "888", V1: "/ops/handleAlert", V2: "POST"},
		{Ptype: "p", V0: "888", V1: "/ops/getScheduleList", V2: "GET"},
		{Ptype: "p", V0: "888", V1: "/ops/createBackupTask", V2: "POST"},
		{Ptype: "p", V0: "888", V1: "/ops/updateBackupTask", V2: "PUT"},
		{Ptype: "p", V0: "888", V1: "/ops/toggleBackupTask", V2: "POST"},
		{Ptype: "p", V0: "888", V1: "/ops/runBackupTask", V2: "POST"},
		{Ptype: "p", V0: "888", V1: "/ops/deleteBackupTask", V2: "DELETE"},
		{Ptype: "p", V0: "888", V1: "/ops/getBackupTaskList", V2: "POST"},
		{Ptype: "p", V0: "888", V1: "/ops/getBackupRecordList", V2: "POST"},
		{Ptype: "p", V0: "888", V1: "/ops/downloadBackup", V2: "GET"},
